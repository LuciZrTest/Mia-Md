...
##  Prerequisites
 ...
 ```SH
> git clone https://github.com/LuciZR/Mia-Md
> cd GURU-BOT
 ```
 ...
 [Set it up on Heroku](https://github.com/LuciZR/Mia-Md/blob/master/Heroku-Hosting-Guide.md)
